...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="aboutus.jsp"><i class="fa fa-book" aria-hidden="true"></i> About Us <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
...
<div class="container-fluid back-image">
		...
		<div class="phone">
  <a href="Tel:+9779819245846">
    <h5><i class="fa fa-phone fa-3x fa-spin" aria-hidden="true"></i></h5>
  </a>
</div>
...
<a href="https://wa.me/9779819245846">
<img alt="" src="whatsApp.png" style="width: 70px;height: 70px">
</a>
</center>
</div>
